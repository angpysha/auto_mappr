...
class $Mappr implements _i1.AutoMapprInterface {
  ...
  TARGET? _convert<SOURCE, TARGET>(
    ...
    if ((sourceTypeOf == _typeOf<_i2.UserDto>() ||
      ...
      return (_map_UserDto_To_User((model as _i2.UserDto?)) as TARGET);
    }
    if ((sourceTypeOf == _typeOf<_i2.UserDto>() ||
            sourceTypeOf == _typeOf<_i2.UserDto?>()) &&
        (targetTypeOf == _typeOf<_i2.AnotherUser>() ||
      ...
      return (_map_UserDto_To_AnotherUser((model as _i2.UserDto?)) as TARGET);
    }
  ...
  _i2.User _map_UserDto_To_User(_i2.UserDto? input) {
    final model = input;
    if (model == null) {
      throw Exception(
  ...
  _i2.AnotherUser _map_UserDto_To_AnotherUser(_i2.UserDto? input) {
    final model = input;
    if (model == null) {
      throw Exception(
